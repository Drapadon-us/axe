...
module.exports = {
    ...
    async execute (interaction) {
        ...
        if (!interaction.member.permissions.has(PermissionsBitField.Flags.ManageMessages) && interaction.user.id !== '1126815798581792768') return await interaction.editReply({ content: 'You **do not** have the permission to do that!', ephemeral: true});
